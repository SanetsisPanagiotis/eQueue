...
export class BookService {
  ...
  private booksUrl = 'api/restaurants';
  ...
  updateBook (book: Book): Observable<Book> {
    ...
    return this.http.put(url,  JSON.stringify(book), httpOptions).pipe(
  ...
  searchBooks(term: string): Observable<Book[]> {
    ...
    return this.http.get<Book[]>(`api/restaurants/?title=${term}`).pipe(
